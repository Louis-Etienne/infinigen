...
module load apptainer cuda optix
...
export OUTPUT_DIR="/output_dir/outputs/my_datasets_error2/3449c79b/"
...
#
# python -m infinigen_examples.generate_nature --seed 0 --task render --input_folder $OUTPUT_DIR/coarse --output_folder $OUTPUT_DIR/results -p render.render_image_func=@flat/render_image 
